...
namespace PetShop.Data.Migrations
{
    ...
    [Migration("20230713062320_ImplementLastEditPropertyToItemEntity")]
    partial class ImplementLastEditPropertyToItemEntity
    {
            ...
            modelBuilder.Entity("PetShop.Data.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8001),
                            CategoryId = 1,
                            Description = "Yellow hoodie with minion motifs, size M, suitable for colder winter days.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8037),
                            Price = 25.50m,
                        ...
                        {
                            Id = 2,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8048),
                            CategoryId = 1,
                            Description = "Green hoodie with bear motifs and eyelets on the hood, size M, suitable for colder winter days.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8049),
                            Price = 35.90m,
                        ...
                        {
                            Id = 3,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8052),
                            CategoryId = 1,
                            Description = "Thick blue blouse with bears and rose leaf motifs, size M.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8053),
                            Price = 20.30m,
                        ...
                        {
                            Id = 4,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8056),
                            CategoryId = 1,
                            Description = "Purple clean hoodie with pocket, size M.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8057),
                            Price = 19.90m,
                            Title = "Hoodie - Lilac",
                        ...
                        {
                            Id = 5,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8061),
                            CategoryId = 1,
                            Description = "A thick pink blouse that looks like a cute pajama, size M, perfect for colder winter days.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8062),
                            Price = 20.30m,
                        ...
                        {
                            Id = 6,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8064),
                            CategoryId = 3,
                            Description = "Plush ice cream, with a push button and a rope on the top.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8066),
                            Price = 10.10m,
                            Title = "Ice cream",
                        ...
                        {
                            Id = 7,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8068),
                            CategoryId = 3,
                            Description = "A large flat octopus that can turn and change color.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8069),
                            Price = 8.80m,
                            Title = "Octopus",
                        ...
                        {
                            Id = 8,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8071),
                            CategoryId = 3,
                            ...
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8072),
                            Price = 9.50m,
                            Title = "Sleeper",
                        ...
                        {
                            Id = 9,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8076),
                            CategoryId = 6,
                            Description = "Sanitary napkins with patches.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8077),
                            Price = 16.90m,
                            Title = "Toilet Pads",
                        ...
                        {
                            Id = 10,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8109),
                            CategoryId = 7,
                            Description = "Double-sided comb for combing your pet with thicker fur.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8110),
                            Price = 14.50m,
                        ...
                        {
                            Id = 11,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8112),
                            CategoryId = 7,
                            Description = "A comb specially designed for pets with short fur. Ideal for the shedding period.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8114),
                            Price = 34.15m,
                        ...
                        {
                            Id = 12,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8116),
                            CategoryId = 5,
                            ...
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8117),
                            Price = 55.00m,
                        ...
                        {
                            Id = 13,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8119),
                            CategoryId = 4,
                            ...
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8120),
                            Price = 32.90m,
                        ...
                        {
                            Id = 14,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8122),
                            CategoryId = 4,
                            Description = "Pink plastic cage, suitable for pets up to 6 kg.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8124),
                            Price = 20.90m,
                        ...
                        {
                            Id = 15,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8126),
                            CategoryId = 8,
                            Description = "Ceramic water bowl 300ml",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8127),
                            Price = 8.50m,
                            Title = "Water Bowl",
                        ...
                        {
                            Id = 16,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8129),
                            CategoryId = 8,
                            Description = "Ceramic food bowl 250ml",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8132),
                            Price = 7.50m,
                            Title = "Food Bowl",
                        ...
                        {
                            Id = 17,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8135),
                            CategoryId = 2,
                            Description = "Adjustable chest for small breeds up to 4kg, suitable for warmer summer days.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8136),
                            Price = 19.90m,
                        ...
                        {
                            Id = 18,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8138),
                            CategoryId = 2,
                            Description = "Thick, padded pink bib for small breeds up to 3kg, suitable for colder and cooler days.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8139),
                            Price = 14.30m,
                        ...
                        {
                            Id = 19,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8143),
                            CategoryId = 2,
                            Description = "Brown leather collar with attached bell designed for smaller breeds.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8144),
                            Price = 5.90m,
                        ...
                        {
                            Id = 20,
                            AddedOn = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8146),
                            CategoryId = 3,
                            Description = "Knitted ball with ropes on both sides.",
                            LastEdit = new DateTime(2023, 7, 13, 9, 23, 20, 171, DateTimeKind.Local).AddTicks(8147),
                            Price = 12.00m,
                            Title = "Ball - Rope",
